...
<div style="min-height: 100vh;" class="bg-bgutama">
    ...
    <div class="p-16 px-24">
        ...
        <div class="w-full bg-white rounded-lg p-5">
            <form action="{{ route('manajer.update', $menu->id) }}" method="POST" enctype="multipart/form-data" class="mx-auto">
                @csrf
                @method('PUT')
                <div class="grid gap-6 mb-6 md:grid-cols-1">
                    <div>
                        <label for="nama" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama</label>
                        <input value="{{$menu->nama}}" type="text" id="nama" class=" bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Contoh: Espresso" required name="nama">
                    </div>
                    <div>
