                ...
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        ...
                        <tr class=" odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                            ...
                            @if(empty($transaction->nama_kasir))
                            <td class="px-6 py-4">
                                <a href="{{ route('keranjang_meja', ['no_meja' => $transaction->no_meja, 'id_transaksi' => $transaction->id]) }}">
                                ...
                                <br>
                                <a href="{{ route('keranjang_meja', ['no_meja' => $transaction->no_meja, 'id_transaksi' => $transaction->id]) }}">
                                    <button type="button" class="text-white focus:ring-4 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-red-800 w-44">Batal</button>
                                </a>
                            </td>
                            @else
